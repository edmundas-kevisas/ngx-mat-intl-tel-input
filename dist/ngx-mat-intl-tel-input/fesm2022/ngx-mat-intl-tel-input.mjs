...
import { Injectable, Pipe, EventEmitter, ChangeDetectionStrategy, Component, Optional, Self, Input, HostBinding, Output, ViewChild } from '@angular/core';
...
class CountryCode {
    ...
    static ɵfac = function CountryCode_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || CountryCode)(); };
...
class SearchPipe {
    ...
    static ɵfac = function SearchPipe_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || SearchPipe)(); };
    static ɵpipe = /*@__PURE__*/ i0.ɵɵdefinePipe({ name: "search", type: SearchPipe, pure: true });
}
...
function NgxMatIntlTelInputComponent_span_3_Template(rf, ctx) { if (rf & 1) {
    ...
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1("+", ctx_r1.selectedCountry.dialCode);
} }
function NgxMatIntlTelInputComponent_input_6_Template(rf, ctx) { if (rf & 1) {
    const _r3 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "input", 12);
    i0.ɵɵtwoWayListener("ngModelChange", function NgxMatIntlTelInputComponent_input_6_Template_input_ngModelChange_0_listener($event) { i0.ɵɵrestoreView(_r3); const ctx_r1 = i0.ɵɵnextContext(); i0.ɵɵtwoWayBindingSet(ctx_r1.searchCriteria, $event) || (ctx_r1.searchCriteria = $event); return i0.ɵɵresetView($event); });
    i0.ɵɵlistener("click", function NgxMatIntlTelInputComponent_input_6_Template_input_click_0_listener($event) { i0.ɵɵrestoreView(_r3); return i0.ɵɵresetView($event.stopPropagation()); });
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵtwoWayProperty("ngModel", ctx_r1.searchCriteria);
    i0.ɵɵproperty("placeholder", ctx_r1.searchPlaceholder);
} }
function NgxMatIntlTelInputComponent_ng_container_7_button_1_span_5_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementStart(0, "span");
    i0.ɵɵtext(1);
    i0.ɵɵelementEnd();
} if (rf & 2) {
    const country_r5 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance();
    i0.ɵɵtextInterpolate1("+", country_r5.dialCode);
} }
function NgxMatIntlTelInputComponent_ng_container_7_button_1_Template(rf, ctx) { if (rf & 1) {
    const _r4 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 14);
    i0.ɵɵlistener("click", function NgxMatIntlTelInputComponent_ng_container_7_button_1_Template_button_click_0_listener() { const country_r5 = i0.ɵɵrestoreView(_r4).$implicit; const ctx_r1 = i0.ɵɵnextContext(2); const focusable_r6 = i0.ɵɵreference(10); return i0.ɵɵresetView(ctx_r1.onCountrySelect(country_r5, focusable_r6)); });
    i0.ɵɵelementStart(1, "div", 15);
    i0.ɵɵelement(2, "div", 16);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "div", 17);
    i0.ɵɵtext(4);
    i0.ɵɵtemplate(5, NgxMatIntlTelInputComponent_ng_container_7_button_1_span_5_Template, 2, 1, "span", 8);
    i0.ɵɵelementEnd()();
} if (rf & 2) {
    const country_r5 = ctx.$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngClass", country_r5.flagClass);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate1(" ", country_r5.name, " ");
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngIf", country_r5 == null ? null : country_r5.dialCode);
} }
function NgxMatIntlTelInputComponent_ng_container_7_mat_divider_2_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelement(0, "mat-divider");
} }
function NgxMatIntlTelInputComponent_ng_container_7_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementContainerStart(0);
    i0.ɵɵtemplate(1, NgxMatIntlTelInputComponent_ng_container_7_button_1_Template, 6, 3, "button", 13)(2, NgxMatIntlTelInputComponent_ng_container_7_mat_divider_2_Template, 1, 0, "mat-divider", 8);
...
function NgxMatIntlTelInputComponent_ng_container_8_button_1_Template(rf, ctx) { if (rf & 1) {
    const _r7 = i0.ɵɵgetCurrentView();
    i0.ɵɵelementStart(0, "button", 14);
    i0.ɵɵlistener("click", function NgxMatIntlTelInputComponent_ng_container_8_button_1_Template_button_click_0_listener() { i0.ɵɵrestoreView(_r7); const country_r8 = i0.ɵɵnextContext().$implicit; const ctx_r1 = i0.ɵɵnextContext(); const focusable_r6 = i0.ɵɵreference(10); return i0.ɵɵresetView(ctx_r1.onCountrySelect(country_r8, focusable_r6)); });
    i0.ɵɵelementStart(1, "div", 15);
    i0.ɵɵelement(2, "div", 16);
    i0.ɵɵelementEnd();
    i0.ɵɵelementStart(3, "div", 17);
    ...
    const country_r8 = i0.ɵɵnextContext().$implicit;
    i0.ɵɵadvance(2);
    i0.ɵɵproperty("ngClass", country_r8.flagClass);
    i0.ɵɵadvance(2);
    i0.ɵɵtextInterpolate2(" ", country_r8.name, " +", country_r8.dialCode, " ");
} }
function NgxMatIntlTelInputComponent_ng_container_8_Template(rf, ctx) { if (rf & 1) {
    i0.ɵɵelementContainerStart(0);
    i0.ɵɵtemplate(1, NgxMatIntlTelInputComponent_ng_container_8_button_1_Template, 5, 3, "button", 18);
    i0.ɵɵpipe(2, "search");
    i0.ɵɵelementContainerEnd();
} if (rf & 2) {
    ...
    const ctx_r1 = i0.ɵɵnextContext();
    i0.ɵɵadvance();
    i0.ɵɵproperty("ngIf", i0.ɵɵpipeBind2(2, 1, country_r8, ctx_r1.searchCriteria));
} }
class NgxMatIntlTelInputComponent {
    _changeDetectorRef;
    countryCodeData;
    fm;
    elRef;
    ...
    get errorState() {
        ...
        const isSubmitted = this._parentFormGroup?.submitted || this._parentForm?.submitted || false;
    ...
    static ɵfac = function NgxMatIntlTelInputComponent_Factory(__ngFactoryType__) { return new (__ngFactoryType__ || NgxMatIntlTelInputComponent)(i0.ɵɵdirectiveInject(i0.ChangeDetectorRef), i0.ɵɵdirectiveInject(CountryCode), i0.ɵɵdirectiveInject(i2.FocusMonitor), i0.ɵɵdirectiveInject(i0.ElementRef), i0.ɵɵdirectiveInject(i3.NgControl, 10), i0.ɵɵdirectiveInject(i3.NgForm, 8), i0.ɵɵdirectiveInject(i3.FormGroupDirective, 8), i0.ɵɵdirectiveInject(i4.ErrorStateMatcher)); };
    static ɵcmp = /*@__PURE__*/ i0.ɵɵdefineComponent({ type: NgxMatIntlTelInputComponent, selectors: [["ngx-mat-intl-tel-input"]], viewQuery: function NgxMatIntlTelInputComponent_Query(rf, ctx) { if (rf & 1) {
            i0.ɵɵviewQuery(MatMenu, 5);
        } if (rf & 2) {
            let _t;
            i0.ɵɵqueryRefresh(_t = i0.ɵɵloadQuery()) && (ctx.matMenu = _t.first);
        } }, hostVars: 3, hostBindings: function NgxMatIntlTelInputComponent_HostBindings(rf, ctx) { if (rf & 2) {
            i0.ɵɵdomProperty("id", ctx.id);
            i0.ɵɵclassProp("ngx-floating", ctx.shouldLabelFloat);
        } }, inputs: { preferredCountries: "preferredCountries", enablePlaceholder: "enablePlaceholder", inputPlaceholder: "inputPlaceholder", cssClass: "cssClass", name: "name", onlyCountries: "onlyCountries", errorStateMatcher: "errorStateMatcher", enableSearch: "enableSearch", searchPlaceholder: "searchPlaceholder", describedBy: "describedBy", format: "format", placeholder: "placeholder", required: "required", disabled: "disabled" }, outputs: { countryChanged: "countryChanged" }, features: [i0.ɵɵProvidersFeature([
                CountryCode,
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassMetadata(NgxMatIntlTelInputComponent, [{
        ...
        args: [{ selector: "ngx-mat-intl-tel-input", standalone: true, imports: [
                ...
                type: Optional
            }] }, { type: i4.ErrorStateMatcher }], { preferredCountries: [{
            type: Input
        }], enablePlaceholder: [{
            type: Input
        }], inputPlaceholder: [{
...
(() => { (typeof ngDevMode === "undefined" || ngDevMode) && i0.ɵsetClassDebugInfo(NgxMatIntlTelInputComponent, { className: "NgxMatIntlTelInputComponent", filePath: "lib/ngx-mat-intl-tel-input.component.ts", lineNumber: 79 }); })();
